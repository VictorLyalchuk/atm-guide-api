    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ATMModel", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ATMSoft", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ATMModelId = table.Column<int>(type: "integer", nullable: true),
                    ATMSoftId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ATM", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ATM_ATMModel_ATMModelId",
                        column: x => x.ATMModelId,
                        principalTable: "ATMModel",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ATM_ATMSoft_ATMSoftId",
                        column: x => x.ATMSoftId,
                        principalTable: "ATMSoft",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Symptom = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProblemSolution_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendedAction = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    Time = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CategoryId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ATMErrorCode", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ATMErrorCode_ATM_ATMId",
                        column: x => x.ATMId,
                        principalTable: "ATM",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ATMErrorCode_Category_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Category",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppSession_ATM_ATMId",
                        column: x => x.ATMId,
                        principalTable: "ATM",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppSession_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ATMId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    RequestReasonId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupportRequest", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupportRequest_ATM_ATMId",
                        column: x => x.ATMId,
                        principalTable: "ATM",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupportRequest_RequestReason_RequestReasonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LogSession_AppSession_AppSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppSession_ATMId",
                table: "AppSession",
                column: "ATMId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSession_UserId",
                table: "AppSession",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ATM_ATMModelId",
                table: "ATM",
                column: "ATMModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ATM_ATMSoftId",
                table: "ATM",
                column: "ATMSoftId");

            migrationBuilder.CreateIndex(
                name: "IX_ATMErrorCode_ATMId",
                table: "ATMErrorCode",
                column: "ATMId");

            migrationBuilder.CreateIndex(
                name: "IX_ATMErrorCode_CategoryId",
                table: "ATMErrorCode",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Instruction_ATMId",
                table: "Instruction",
                column: "ATMId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogSession_AppSessionId",
                table: "LogSession",
                column: "AppSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProblemSolution_CategoryId",
                table: "ProblemSolution",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportRequest_ATMId",
                table: "SupportRequest",
                column: "ATMId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportRequest_RequestReasonId",
                table: "SupportRequest",
